...
public class Main {
    ...
    private static final String CLIENT_KEY = RENGER_FINANCE;
    
    public static void main(String[] args) {
        bearerToken = getBearerToken(CLIENT_KEY);
        // printInkoopFacturen();
